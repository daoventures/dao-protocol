...
Uncomment code in deploy/compound_farmer/hardhat/hardhat.js from line 41 to line 60
```
...
```
npx hardhat run --network mainnet scripts/compound_farmer/addresses.js
```
Sample output:
```
Summary:
