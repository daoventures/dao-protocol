...
contract DAOVault is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function init(bytes32 _vaultName, address _token, address _strategy, address _owner) external initializer {
        __ERC20_init("DAOVault Low DAI", "dvlDAI");
        ...
        networkFeeTier2 = [50000e18+1, 100000e18];
        customNetworkFeeTier = 1000000e18;
    ...
    function getCurrentBalance(address _address) external view returns (uint256 result) {
        ...
        result = _shares > 0 ? (strategy.pool()).mul(_shares).div(totalSupply()) : 0;
    }
