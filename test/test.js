...
describe("DAO ElonApe Strategy", () => {
    it("should work", async () => {
        ...
        tx = await elonApeVault.connect(client).deposit(ethers.utils.parseUnits("10000", 6), 0)
        // receipt = await tx.wait()
        // console.log("Deposit gas used:", receipt.gasUsed.toString())
        // console.log(ethers.utils.formatEther(await elonApeVault.balanceOf(deployer.address)))
        tx = await elonApeVault.connect(client).deposit(ethers.utils.parseUnits("10000", 6), 1)
        // receipt = await tx.wait()
        // console.log(receipt.gasUsed.toString())
        // console.log(ethers.utils.formatEther(await elonApeVault.balanceOf(deployer.address)))
        tx = await elonApeVault.connect(client).deposit(ethers.utils.parseUnits("10000", 18), 2)
        // receipt = await tx.wait()
        // console.log(receipt.gasUsed.toString())
        // console.log(ethers.utils.formatEther(await elonApeVault.balanceOf(deployer.address)))
