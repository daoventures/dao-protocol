...
const baseCoinAddr = "0xa47c8bf37f92aBed4A126BDA807A7b7498661acD" // *variable
...
const unlockedBaseCoinAddr = "0xf584F8728B874a6a5c7A8d4d387C9aae9172D621" // *variable
const unlocked3CrvAddr = "0xa7888F85BD76deeF3Bd03d4DbCF57765a49883b3"

const curvePoolAddr = "0x890f4e345B1dAED0367A877a1612f86A1f86985f" // *variable
const curvePoolZap = "0xB0a0716841F2Fc03fbA72A891B8Bb13584F52F2d" // *variable

const poolIndex = 21 // *variable
const curveZapType = "CurveMetaPoolZapIndividual" // *variable
...
describe("DAO Earn", () => {
    it("should work", async () => {
        ...
        const earnStrategyAddr = await earnStrategyFactory.strategies(0)
        ...
        const earnVaultAddr = await earnVaultFactory.vaults(0)
        ...
        // Deposit
        await earnVault.connect(client)["deposit(uint256)"](ethers.utils.parseEther("10000"))
        ...
        // await earnVault.connect(admin).retrieveLpTokenFromStrategy(ethers.utils.parseEther("1000"))
        // console.log(ethers.utils.formatEther(await lpTokenContract.balanceOf(earnVault.address)))
        ...
        await expect(earnVault.connect(client)["deposit(uint256)"](ethers.utils.parseEther("10000"))).to.be.revertedWith("Pausable: paused")
        ...
        await earnVault.connect(client)["withdraw(uint256)"](withdrawAmt)
        ...
        const sample = await Sample.deploy(lpTokenAddr, earnVaultAddr)
        ...
        // Admin functions
        await earnVault.connect(admin).setPercTokenKeepInVault(100)
        expect((await earnVault.percKeepInVault())).to.equal(100)
