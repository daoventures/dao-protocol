...
const baseCoinAddr = "0x9BE89D2a4cd102D8Fecc6BF9dA793be995C22541" // *variable // 8 decimals
...
const unlockedBaseCoinAddr = "0x28C6c06298d514Db089934071355E5743bf21d60" // *variable
const unlockedCrvRenWSBTCAddr = "0x545946fcAE98Afb4333B788b8F530046eB8Ed997"

const curvePoolAddr = "0x071c661B4DeefB59E2a3DdB20Db036821eeE8F4b" // *variable
const curvePoolZap = "0xC45b2EEe6e09cA176Ca3bB5f7eEe7C47bF93c756" // *variable

const poolIndex = 19 // *variable
...
describe("DAO Earn", () => {
    it("should work", async () => {
        ...
        await baseCoinContract.transfer(client.address, ethers.utils.parseUnits("2", 8))
        ...
        tx = await curveZap.connect(client).deposit(earnVault.address, ethers.utils.parseUnits("1", 8), baseCoinAddr, false)
        ...
        await curveZap2.connect(client).deposit(earnVault.address, ethers.utils.parseUnits("1", 8), baseCoinAddr, false)
        ...
        console.log("sBTC withdraw:", ethers.utils.formatEther(await sBTCContract.balanceOf(client.address)))
        console.log("Base coin withdraw:", ethers.utils.formatUnits(await baseCoinContract.balanceOf(client.address), 8))
