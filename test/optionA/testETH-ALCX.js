...
describe("OA - ETHALCX", () => {
    const setup = async () => {
        ...
        const lpToken = new ethers.Contract(addresses.TOKENS.ETHALCXLP, IERC20_ABI, deployer)
        ...
        await ALCX.connect(unlockedUser).approve(vault.address, ethers.utils.parseUnits("1000000000", 6))
        ...
        await ALCX.connect(unlockedUser2).approve(vault.address, ethers.utils.parseUnits("1000000000", 6))
        ...
        return { vault, USDT, ALCX, DAI, WETH, lpToken, unlockedUser, unlockedUser2, adminSigner, deployer, SushiRouter }
    }
    ...
    it("should work - normal flow", async () => {
        const { vault, ALCX, USDT, DAI, WETH, lpToken, unlockedUser, unlockedUser2, adminSigner, deployer, SushiRouter } = await setup()
        ...
        await SushiRouter.connect(unlockedUser).addLiquidity(ALCX.address, WETH.address, ethers.utils.parseUnits("10000", 6), ethers.utils.parseUnits("1", 18), 0, 0, unlockedAddress, 32490605417);
        ...
        await SushiRouter.connect(unlockedUser2).addLiquidity(ALCX.address, WETH.address, ethers.utils.parseUnits("10000", 6), ethers.utils.parseUnits("1", 18), 0, 0, unlockedAddress2, 32490605417);
    ...
    it("Should yield correctly", async () => {
        const { vault, strategy, ALCX, USDT, WETH, lpToken, unlockedUser, unlockedUser2, adminSigner, deployer, SushiRouter } = await setup()
        await SushiRouter.connect(unlockedUser).swapExactTokensForTokens(ethers.utils.parseUnits("100", 18), 0, [ALCX.address, WETH.address], unlockedAddress, 32490605417);
        await SushiRouter.connect(unlockedUser).addLiquidity(ALCX.address, WETH.address, ethers.utils.parseUnits("10000", 6), ethers.utils.parseUnits("1", 18), 0, 0, unlockedAddress, 32490605417);
    ...
    it("Should withdraw all funds in emergencyWithdraw", async () => {
        const { vault, strategy, ALCX, USDT, WETH, lpToken, unlockedUser, unlockedUser2, adminSigner, deployer, SushiRouter } = await setup()
        await SushiRouter.connect(unlockedUser).swapExactTokensForTokens(ethers.utils.parseUnits("100", 18), 0, [ALCX.address, WETH.address], unlockedAddress, 32490605417);
        await SushiRouter.connect(unlockedUser).addLiquidity(ALCX.address, WETH.address, ethers.utils.parseUnits("100", 18), ethers.utils.parseUnits("1", 18), 0, 0, unlockedAddress, 32490605417);

        await SushiRouter.connect(unlockedUser2).swapExactTokensForTokens(ethers.utils.parseUnits("100", 18), 0, [ALCX.address, WETH.address], unlockedAddress2, 32490605417);
        await SushiRouter.connect(unlockedUser2).addLiquidity(ALCX.address, WETH.address, ethers.utils.parseUnits("100", 18), ethers.utils.parseUnits("1", 18), 0, 0, unlockedAddress2, 32490605417);
